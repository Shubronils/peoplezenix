...
import logo2 from "../assets/peoplezenix-logoo.png";
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6 mt-6 max-w-sm">
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-wrap items-center gap-6 text-sm text-muted-foreground">
            <span className="flex items-center gap-2"><Mail className="w-4 h-4 text-primary" /> hello@PeopleZenix.com</span>
            <span className="flex items-center gap-2"><Phone className="w-4 h-4 text-primary" /> +1 (555) 123-4567</span>
            <span className="flex items-center gap-2"><MapPin className="w-4 h-4 text-primary" /> Ahemdabad, Gujarat, India</span>
          </div>
          <p className="text-sm text-muted-foreground">© 2026 PeopleZenix. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
